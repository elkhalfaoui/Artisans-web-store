...
//   ]);
  ...
  return (
    <div>
      <header className="stiky top-0 left-0 w-full bg-white">
        <div className="container m-auto px-4 grid grid-cols-1 lg:grid-cols-3">
          <div className="col-span-1 flex justify-between items-center bg-white absolute lg:relative w-full lg:w-fit lg:h-fit left-0 top-0 px-4 py-2 lg:px-0 z-50">
          ...
          <nav
            className={`col-span-2 flex flex-col lg:flex-row justify-between py-6 lg:py-0 bg-white border-b-2 lg:border-0 border-sky-700 w-full h-fit lg:h-full absolute lg:relative left-0 lg:top-0 z-40 duration-500 ${
