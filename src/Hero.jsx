      ...
      <ul className="grid grid-cols-1 md:grid-cols-5 items-center gap-y-12 px-4">
        ...
        <li className="col-span-3 relative rounded-2xl overflow-hidden aspect-[16/9] order-1 md:order-2">
          ...
          >
            ...
            <li className="h-full w-1/5">
              <img src={desk} alt="" className="w-full h-full object-cover" />
            </li>
            <li className="h-full w-1/5">
              <img src={bed} alt="" className="w-full h-full object-cover" />
            </li>
            <li className="h-full w-1/5">
              <img src={door} alt="" className="w-full h-full object-cover" />
            </li>
            <li className="h-full w-1/5">
              <img src={biblio} alt="" className="w-full h-full object-cover" />
            </li>
          </ul>
